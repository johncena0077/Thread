...
public struct SlideMenuOptions {
    public static var leftViewWidth: CGFloat = min(UIScreen.main.bounds.size.width * 0.7, 332) // Side menu will be minimum of 70% of the screen or Split Screen Primary Column Width
...
extension UIApplication {
    ...
    /// This method will return the top most controller from the window
    ///
    /// - Parameter viewController: An object of UIViewController
